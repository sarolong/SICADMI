                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-8 mb-4 px-0">
                        <div class="card-header py-3 text-center">
                            ...
                            <label for="basic-url" class="form-label mt-3">Nivel del Caso</label>
                                <div class="input-group mb-2">
                                    <div class="input-group-text">
                                        <input class="form-check mt-0" type="radio" value="" aria-label="Radio button for following text input">
                                    </div>
                                        <input type="text" class="form-control" placeholder="Primer Nivel de Soporte: Urgente" aria-label="Text input with radio button">
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-text">
                                        <input class="form-check mt-0" type="radio" value="" aria-label="Radio button for following text input">
                                    </div>
                                        <input type="text" class="form-control" placeholder="Segundo Nivel de Soporte: Intermedio" aria-label="Text input with radio button">
                                </div>
                                <div class="input-group">
                                    <div class="input-group-text">
                                        <input class="form-check mt-0" type="radio" value="" aria-label="Radio button for following text input">
                                    </div>
                                        <input type="text" class="form-control" placeholder="Tercer Nivel de Soporte: Basico" aria-label="Text input with radio button">
                                </div>
